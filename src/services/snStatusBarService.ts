...
const STATUS_BAR_COMMANDS: SnStatusBarCommandDescriptor[] = [
  ...
  {
    id: SN_SYNC_COMMANDS.OPEN_CURRENT_IN_INSTANCE,
    label: "sn: open current in instance",
    text: "sn open current",
  ...
  {
    id: SN_SYNC_COMMANDS.PULL_CURRENT,
    label: "sn: pull current",
    text: "sn pull current",
    requiresActiveEditor: true,
    priority: 89,
  },
  {
